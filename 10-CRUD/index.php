...
<body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" style="margin-bottom: 30px;">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./img/cina2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/cinamon1.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <button class="boton" type="button" ><a href="./curso.php">Administra</a></button>
    ...
    <div class="container text-center" style="margin-top: 30px; background-color: white;">
        <div class="row align-items-center">
            ...
            <div class="col" style="padding: 20px;">
                <img src="./img/aaa.jpg" alt="" style="width: 500px; height: 500px;">
            </div>
        </div>
    </div>
